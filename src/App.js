...
function App() {
  ...
  let qualityCheck;
    if
        ((handleChange) == '7' && '11' && '15'){
        qualityCheck = <p>Nope !</p>;
        }
      else if
        ((handleChange) == '7', '11' && '7', '15' && '11', '15'){
        ...
        ((handleChange) == '7', '14' && '11', '14' && '14', '15' && '7', '11', '14' && '7', '14', '15' && '11', '14', '15'&& '7', '11', '14', '15' ){
        ...
        ((handleChange) == '1', '2', '3', '4', '5', '6', '9', '10', '12', '13', '14'){
        qualityCheck = <p>Okey ! Okey ! It's happenning !</p>;
      }
      else if
        ((handleChange) == '1', '2', '3', '4', '5', '6', '10', '12', '13'){
        qualityCheck = <p>Yup, nice dev bro !</p>;
      }
      else if
        ((handleChange) == '1', '2', '3', '4', '5', '6', '9', '10', '12', '13'){
        qualityCheck = <p>Yup, nice dev bro !</p>;
      }
      else if
      ((handleChange) == '5', '6', '9'){
